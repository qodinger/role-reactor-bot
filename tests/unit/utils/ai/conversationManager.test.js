...
describe("ConversationManager", () => {
  ...
  describe("Conversation History Management", () => {
    ...
    it("should not persist system messages to storage", async () => {
      ...
      // We are waiting for the write debounce timeout to finish before doing assertion
  ...
  describe("Storage Integration", () => {
    ...
    it("should handle storage errors gracefully", async () => {
      ...
      await expect(
        conversationManager.addToHistory(userId, guildId, {
          role: "user",
          content: "Test",
        }),
  ...
  describe("Memory Management", () => {
    it("should evict oldest conversation when at capacity", async () => {
      ...
      const history3 = await conversationManager.getConversationHistory(
        "user3",
        "guild3",
      );
