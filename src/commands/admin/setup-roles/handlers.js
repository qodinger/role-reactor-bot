...
/**
 * Handle the main setup roles logic
 * @param {import('discord.js').CommandInteraction} interaction
 * @param {import('discord.js').Client} client
 */
export async function handleSetupRoles(interaction, client) {
  ...
  try {
    ...
    // Determine the specific error type and handle it
    await handleSetupRolesError(interaction, error);
  }
}

/**
 * Handle setup roles errors with specific error messages
 * @param {import('discord.js').CommandInteraction} interaction
 * @param {Error} error
 */
async function handleSetupRolesError(interaction, error) {
